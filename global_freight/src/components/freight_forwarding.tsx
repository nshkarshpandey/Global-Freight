...
export default function Freight_Forwarding() {
  ...
  return (
    <section ref={ref}>
      <div className="flex flex-col md:flex-row p-8 gap-8  for-main-cont">
        ...
        <div className="w-full flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 relative left-[10%] for-txt-cont ">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[70px] font-bold text-black for-txt-1  h-[150px]">
